...
export class ValuePipe implements PipeTransform {
  ...
  private replacements: [RegExp, string][] = [
        ...
        [/%%(?<tag>chaos|fire|cold|lightning|crafted|crucible|fractured|foulborn|sanctified)%%(.*)%%\k<tag>%%/gi, '<span class="prop-$1">$2</span>'],
  ...
  transform(value: any, args?: any): any {
      ...
      else if(value.type?.className.includes(PropertyType.Veiled.className)) {
          return "";
      }
      else {
