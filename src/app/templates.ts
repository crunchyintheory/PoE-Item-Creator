...
export const Templates: Map<string, Item|SerializedItem> = ([
    ...
    {"game":"poe2","rarity":"unique","name":"Paradoxica","base":"Commander Sword","image":"assets/items/Vendetta_Paradoxica_inventory_icon.png","properties":[{"type":"desc","name":"","value":"One Hand Sword"},{"type":"quant","name":"Physical Damage","value":"36-60"},{"type":"quant","name":"Critical Strike Chance","value":"5.00%"},{"type":"augquant","name":"Attacks per Second","value":"1.50"},{"type":"quant","name":"Weapon Range","value":"1.1 %%g%%meters%%g%%"},{"type":"sep","name":"","value":""},{"type":"statreq","name":"","value":"Requires Level 66, 106 Str, 106 Dex"},{"type":"sep","name":"","value":""},{"type":"qual","name":"","value":"+25% to Global Critical Strike Multiplier"},{"type":"sep","name":"","value":""},{"type":"qual","name":"","value":"Attacks with this Weapon deal Double Damage"},{"type":"desecrated","name":"","value":"99% increased Damage against Enemies with Fully Broken Armor"},{"type":"desecrated","name":"","value":"Break Armour equal to 7% of Physical Damage dealt"},{"type":"sep","name":"","value":""},{"type":"flavor","name":"","value":"What has no siblings but is always a twin?"}],"influences":["Desecrated (Abyssal)","None"],"foilType":"None","width":500,"size":"x2x3"}
